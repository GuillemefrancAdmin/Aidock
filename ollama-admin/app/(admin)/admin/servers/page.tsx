...
export default function ServersPage() {
  ...
  const resetForm = () => {
    setForm({ name: "", url: "", gpuAgentUrl: "", gpuIndex: "", active: true });
    setEditingId(null);
    setShowForm(false);
  };
  ...
  const handleEdit = (server: Server) => {
    setForm({
      ...
      gpuIndex: server.gpuIndex != null ? String(server.gpuIndex) : "",
            ...
            {form.gpuAgentUrl && (
              <div>
                <Input
                  ...
                  min={0}
                  value={form.gpuIndex}
                  onChange={(e) => setForm({ ...form, gpuIndex: e.target.value })}
                  placeholder="0"
                />
                      ...
                      {server.gpuAgentUrl && (
                        <span className="inline-flex items-center gap-1">
                          ...
                          <span className="truncate">
                            {server.gpuIndex != null ? `GPU ${server.gpuIndex}` : "GPU"}
                          </span>
                        </span>
                      )}
